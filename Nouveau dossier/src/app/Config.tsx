    ...
    return(
        <div className="w-80 high2 bg-white items-center flex flex-col justify-center space-y-10 font-semibold" >
            <div className="flex flex-col items-center space-y-3">
             <div className="font-bold self-start">Densité d'impression</div>  
             <div> 
            ...
            <div className="flex flex-col items-center space-y-3">
             <div className="font-bold self-start">Qualité d'impression</div> 
             <div>
            ...
            <div className="flex flex-col items-center space-y-3">
             <div className="font-bold self-start">Nombre d'étiquettes</div>   
             <div className="flex items-center border-b border-slate-500 w-20 ">
             <input min={1} onChange={(event)=>{dispatch(changeNumber(event.target.value))}} className="appearance-none bg-transparent border-none w-full text-gray-700  leading-tight focus:outline-none" type="number" placeholder="1" aria-label="Full name"/>
           </div>
           </div>
          { <div className="flex flex-col items-center space-y-3">
           ...
           <button onClick={handleClick} className="bg-blue-800 hover:bg-blue-900 text-white font-bold py-1 px-6 rounded-full">Importer votre modele</button>
           </div>
        </div>
    )
}